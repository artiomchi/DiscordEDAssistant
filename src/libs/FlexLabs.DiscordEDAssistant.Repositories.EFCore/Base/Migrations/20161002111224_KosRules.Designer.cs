...
namespace FlexLabs.DiscordEDAssistant.Repositories.EFCore.Base.Migrations
{
    ...
    [Migration("20161002111224_KosRules")]
    partial class KosRules
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("FlexLabs.DiscordEDAssistant.Repositories.EFCore.Base.Eddb_Commodities_Category", b =>
                {
                    b.Property<int>("ID");
            ...
            modelBuilder.Entity("FlexLabs.DiscordEDAssistant.Repositories.EFCore.Base.Eddb_Stations_SellingModule", b =>
                {
                    b.Property<int>("PK")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("FlexLabs.DiscordEDAssistant.Repositories.EFCore.Base.Eddb_Stations_SellingShip", b =>
                {
                    b.Property<int>("PK")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("FlexLabs.DiscordEDAssistant.Repositories.EFCore.Base.Eddb_Stations_Type", b =>
                {
                    b.Property<int>("ID");
            ...
            modelBuilder.Entity("FlexLabs.DiscordEDAssistant.Repositories.EFCore.Base.KosSimpleRule", b =>
                {
                    b.Property<int>("PK")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("FlexLabs.DiscordEDAssistant.Repositories.EFCore.Base.KosUserRule", b =>
                {
                    b.Property<int>("PK")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("FlexLabs.DiscordEDAssistant.Repositories.EFCore.Base.Upload_Eddb_Commodity", b =>
                {
                    b.Property<int>("PK")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("FlexLabs.DiscordEDAssistant.Repositories.EFCore.Base.Eddb_Commodity", b =>
                {
                    b.HasOne("FlexLabs.DiscordEDAssistant.Repositories.EFCore.Base.Eddb_Commodities_Category", "Category")
                        .WithMany("Modules")
            ...
            modelBuilder.Entity("FlexLabs.DiscordEDAssistant.Repositories.EFCore.Base.Eddb_Station", b =>
                {
                    b.HasOne("FlexLabs.DiscordEDAssistant.Repositories.EFCore.Base.Eddb_Stations_Type", "Type")
                        .WithMany("Stations")
            ...
            modelBuilder.Entity("FlexLabs.DiscordEDAssistant.Repositories.EFCore.Base.Eddb_Stations_SellingModule", b =>
                {
                    b.HasOne("FlexLabs.DiscordEDAssistant.Repositories.EFCore.Base.Eddb_Station", "Station")
