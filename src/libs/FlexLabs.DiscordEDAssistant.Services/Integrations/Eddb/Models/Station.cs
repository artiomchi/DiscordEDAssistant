...
namespace FlexLabs.DiscordEDAssistant.Services.Integrations.Eddb.Models
{
    public class Station
    {
        ...
        public DiscordEDAssistant.Models.External.Eddb.LandingPadSize? max_landing_pad_size { get; set; }
        ...
        public DiscordEDAssistant.Models.External.Eddb.Station Translate()
            => new DiscordEDAssistant.Models.External.Eddb.Station
            {
                ID = id,
                Name = name,
                SystemID = system_id,
